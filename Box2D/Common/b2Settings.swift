...
public let b2_minFloat = Float.leastNormalMagnitude //FLT_MIN
public let b2_maxFloat = Float.greatestFiniteMagnitude //FLT_MAX
public let b2_epsilon = Float.ulpOfOne // FLT_EPSILON;
public let b2_pi: b2Float = Float.pi // Float(M_PI)
